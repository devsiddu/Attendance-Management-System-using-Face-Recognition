...
def manually_fill():
    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/Siddu/Documents/InternShip/Attendace_management_system/Attendance/Manually Attendance/'+DB_table_name+'.csv'
    ...
    SUB = tk.Label(sb, text="Enter Subject : ", width=15, height=2,
                   fg="black", bg="white", font=('times', 15, ' bold '))
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'C:/Users/Siddu/Documents/InternShip/Attendace_management_system/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:\Users\Siddu\Documents\InternShip\Attendace_management_system\Attendance\-------Check atttendance-------"')
...
def admin_panel():
    ...
    def log_in():
        ...
        if username == 'Siddu':
            if password == 'Siddu123':
                ...
                cs = 'C:/Users/Siddu/Documents/InternShip/Attendace_management_system/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
    ...
    un = tk.Label(win, text="Enter username : ", width=15, height=2, fg="black", bg="#d3d3d3",
                  font=('times', 15, ' bold '))
    un.place(x=30, y=50)

    pw = tk.Label(win, text="Enter password : ", width=15, height=2, fg="black",  bg="#d3d3d3",
                  font=('times', 15, ' bold '))
    pw.place(x=30, y=150)
...
message = tk.Label(window, text="Attendance Management System using Face Recognition", bg="pink", fg="#000000", width=50,
...
lbl = tk.Label(window, text="Enter Enrollment : ", width=20, height=2,
               fg="black", bg="#D3D3D3", font=('times', 15, 'bold'))
...
lbl2 = tk.Label(window, text="Enter Name : ", width=20, fg="black",
                bg="#D3D3D3", height=2, font=('times', 15, ' bold '))
...
clearButton = tk.Button(window, text="Clear", command=clear, fg="white", bg="#000000",
                        width=10, height=1, activebackground="white", font=('times', 15, ' bold '))
clearButton.place(x=950, y=210)

clearButton1 = tk.Button(window, text="Clear", command=clear1, fg="white", bg="#000000",
                         width=10, height=1, activebackground="white", font=('times', 15, ' bold '))
clearButton1.place(x=950, y=310)

AP = tk.Button(window, text="Check Registered students", command=admin_panel, fg="black",
               bg="red", width=19, height=1, activebackground="white", font=('times', 15, ' bold '))
